// src/pages/user/tabs/ReadingTab.tsx
...
const ReadingTab: React.FC<ReadingTabProps> = ({ courseDetail, progress, onMarkDone }) => {
  return (
    <>
      <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-4 sm:mb-6">
        {courseDetail.title} — Reading
      </h2>
      <CurriculumPanel
        units={courseDetail.curriculum || []}
